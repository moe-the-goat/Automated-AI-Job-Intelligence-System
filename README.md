...
|
|-- feedback_worker/                  Cloudflare Worker (deploys outside this repo)
|   |-- worker.js                     proxy that writes feedback to the logs repo
...
export FEEDBACK_WORKER_URL=https://<worker>.workers.dev   # Cloudflare Worker that proxies feedback writes
